...
This is the complete documentation for Polaris Studio - a local-first, AI-native data IDE built in Python with PySide6.

## Who this is for

**If you are a user** (you want to load data, build pipelines, and ship analysis), start with **[Getting started](getting-started/installation.md)** and walk forward. Each guide builds on the last.

**If you are a developer** (you want to extend, embed, or contribute to Polaris), start with **[Architecture overview](architecture/overview.md)** and **[Developer setup](developer/setup.md)**.

**If you just need a specific answer**, jump straight to the reference. The **[Node reference](nodes/reference.md)** lists every node and its parameters, the **[API reference](developer/api-reference.md)** lists every public class, and the **[FAQ](troubleshooting/faq.md)** covers the most common questions.

---

## How to read these docs

The documentation is split into five tracks that mostly don't depend on each other:
...
| [The AI assistant](user-guide/ai-panel.md) | Chat, preview cards, auto-approve, what the AI can and can't do. |
...
| [AI pipeline](architecture/ai.md) | How the AI emits typed commands, how they're validated, how errors self-correct. |
...
- **Polaris files** end in `.polaris` and are ZIP archives (containing `workflow.json` + embedded data files).
...
- Ask the AI assistant - once configured, it can answer questions about Polaris itself.
